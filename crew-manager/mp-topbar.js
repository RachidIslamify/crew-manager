...
(function () {
  ...
  function injectCss(){
    ...
    css.textContent = [
      ...
      ".cmtb-pill{display:inline-flex;align-items:center;gap:5px;height:26px;line-height:1;white-space:nowrap;font-family:var(--display);font-size:14px;letter-spacing:.3px;color:var(--parch);background:rgba(255,255,255,.06);border:1px solid rgba(241,226,190,.16);border-radius:999px;padding:0 11px 0 3px;}",
      ".cmtb-pill-ic{width:19px;height:19px;flex:0 0 auto;border-radius:50%;display:grid;place-items:center;line-height:1;overflow:hidden;font-size:11px;color:#fff;}",
      ".cmtb-pill-ic svg{width:12px;height:12px;}",

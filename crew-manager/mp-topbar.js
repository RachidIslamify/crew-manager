...
(function () {
  ...
  function injectCss(){
    ...
    css.textContent = [
      ...
      ".cmtb-pill{display:inline-flex;align-items:center;gap:5px;white-space:nowrap;font-family:var(--display);font-size:14px;letter-spacing:.3px;color:var(--parch);background:rgba(255,255,255,.06);border:1px solid rgba(241,226,190,.16);border-radius:999px;padding:2px 10px 2px 3px;}",
      ".cmtb-pill-ic{width:19px;height:19px;flex:0 0 auto;border-radius:50%;display:grid;place-items:center;font-size:11px;color:#fff;}",
